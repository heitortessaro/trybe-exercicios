...
-- Agora, faça uma consulta para exibir o número de empresas (fornecedores)
-- que contém a letra F no código. 
SELECT COUNT(*) FROM Fornecedores
WHERE name LIKE '%F%';

-- Agora escreva uma query para exibir os fornecimentos onde as peças custam
-- mais de R$15,00 e menos de $40,00. Ordene os resultados por ordem crescente. 
SELECT * FROM Fornecimentos
WHERE preco BETWEEN 16 AND 39
ORDER BY preco;

-- Por fim, faça uma query para exibir o número de vendas feitas entre o 
-- dia 15/04/2018 e o dia 30/07/2019. 
