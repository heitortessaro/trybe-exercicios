...
-- que possuam a letra e em seu nome. 
SELECT * FROM Scientists
WHERE Name LIKE '%e%';

-- Escreva uma query para exibir o nome de todos os projetos cujo o código 
-- inicie com a letra A. Ordene o resultado em ordem alfabética. 
SELECT * FROM Projects
WHERE Name LIKE 'A%'
ORDER BY Name;

-- Escreva uma query para exibir o código e nome de todos os projetos que 
-- possuam em seu código o número 3. Ordene o resultado em ordem alfabética. 
SELECT Code, Name FROM Projects
WHERE Code LIKE '%3%'
ORDER BY Name;

-- Escreva uma query para exibir todos os cientistas (valores numéricos) 
...
-- Escreva uma query para exibir o nome e o código de todos os projetos 
